...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net BLDC_DIR_CTRL_0_PHASE_A_SENSE_out [get_bd_pins BLDC_CONTROLLER_0/SENSE_A_in]
  ...
  connect_bd_net -net BLDC_DIR_CTRL_0_PHASE_B_SENSE_out [get_bd_pins BLDC_CONTROLLER_0/SENSE_B_in]
  ...
  connect_bd_net -net inverter_0_out_sig [get_bd_pins BLDC_CONTROLLER_0/SENSE_C_in] [get_bd_pins BLDC_CONTROLLER_0/reset_in] [get_bd_pins inverter_0/out_sig]
