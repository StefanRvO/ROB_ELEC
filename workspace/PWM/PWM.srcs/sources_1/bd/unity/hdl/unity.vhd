...
entity unity is
  ...
  attribute CORE_GENERATION_INFO of unity : entity is "unity,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=unity,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=24,numReposBlks=24,numNonXlnxBlks=17,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=17,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,synth_mode=OOC_per_IP}";
...
VECTOR_INV_0: component unity_VECTOR_INV_0_0
     port map (
      VEC_in(2 downto 0) => DIR_SENSE_0_SENSE_out(2 downto 0),
...
vector_mux_1: component unity_vector_mux_0_1
     port map (
      ...
      in_vec2(2 downto 0) => VECTOR_INV_0_VEC_out(2 downto 0),
