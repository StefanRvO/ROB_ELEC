...
HD_PWD='/home/stefan/PWM/PWM.runs/design_1_Rotary_counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Rotary_counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Rotary_counter_0_0.tcl
