...
HD_PWD='/home/stefan/PWM/PWM.runs/design_1_Debouncer_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Debouncer_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Debouncer_2_0.tcl
